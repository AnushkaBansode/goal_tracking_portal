/**
 * Client-side analytics (mirrors backend/utils/goalAnalytics.js).
 * Recomputed whenever the goals array changes so the dashboard stays in sync.
 */
export function computeGoalAnalytics(goals) {
